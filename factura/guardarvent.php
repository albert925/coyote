	...
	if (isset($_SESSION['us'])) {
		...
		if ($venR=="") {
			echo "<script type='text/javascript'>";
				echo "alert('Numero de venta en blanco');";
				echo "var pagina='../factura';";
			...
			$datos="SELECT * from factura 
				...
				where factura.n_vent='$venR' order by cod_f asc";
			...
			$dompdf->render();
			$dompdf->stream("factura_venta_No"."_"."$venR"."_"."$nmus.pdf");
		}
	}
	else{
		echo "<script>";
