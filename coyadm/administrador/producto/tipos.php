...
<body>
	...
	<section>
		...
		<article id="automargen" class="columninput">
			...
			<input type="text" id="tpnm" />
			<div id="txC"></div>
			<input type="submit" value="Ingresar" id="nvtp" class="botonstyle" />
		</article>
		<article id="automargen" class="flexA">
			<?php
				...
				$ssql="SELECT * from tipo_producto order by nam_tipo asc";
				$rs=mysql_query($ssql,$conexion) or die (mysql_error());
				$num_total_registros= mysql_num_rows($rs);
				$total_paginas= ceil($num_total_registros / $tamno_pagina);
				$gsql="SELECT * from tipo_producto order by nam_tipo asc limit $inicio, $tamno_pagina";
			...
			<article id="dates" class="columninput">
				<input type="text" id="Ftpm_<?php echo $idtp ?>" value="<?php echo $nmtp ?>" />
				<div id="txD_<?php echo $idtp ?>"></div>
				<input type="submit" value="Modificar" class="camtpF" id="botostyl" data-id="<?php echo $idtp ?>" />
				<a href="borr_tipo.php?br=<?php echo $idtp ?>" class="dell">Borrar</a>
			</article>
			<?php
				}
			?>
