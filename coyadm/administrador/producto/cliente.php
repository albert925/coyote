...
<body>
	...
	<section>
		...
		<article id="automargen" class="columninput">
			...
			<input type="text" id="clnm" />
			<div id="txA"></div>
			<input type="submit" value="Ingresar" id="nvcl" class="botonstyle" />
		</article>
		<article id="automargen" class="flexA">
			...
			<article id="dates" class="columninput">
				<input type="text" id="Fclm_<?php echo $idcl ?>" value="<?php echo $nmcl ?>" />
				<div id="txB_<?php echo $idcl ?>"></div>
				<input type="submit" value="Modificar" class="camclF" id="botostyl" data-id="<?php echo $idcl ?>" />
				<a href="borr_cliente.php?br=<?php echo $idcl ?>" class="dell">Borrar</a>
			</article>
			<?php
				}
			?>
